...
@Controller
public class FollowController implements MybbsConstant {
    @Autowired
    ...
    public String getFollowees(@PathVariable("userId") int userId, Page page, Model model) {
        ...
        page.setRows((int) followService.findFolloweeCount(userId, MybbsConstant.ENTITY_TYPE_USER));
    ...
    /**
     * Judge whether the current user has followed a certain user
     * @param userId
     * @return
     */
