...
import fi.aalto.forum.dao.elasticsearch.DiscussPostRepository;
...
public class ElasticsearchService {
    ...
    public Map<String, Object> searchDiscussPost(String keyword, int start, int limit){
        ...
        Integer totalNumber = getAllMatchedResult(keyword);
    ...
    private int getAllMatchedResult(String keyword) {
